...
class CreateDoPresenter (val view: CreateDoView, val boxStore: BoxStore): Presenter {
    ...
    fun onCreateButtonClicked() {
        ...
        val newDo = Do (name = view.getCommitmentTitle()!!, complexity = view.getComplexity()!!, startDate = view.getStartDate(),
                expireDate = view.getExpireDate(), period = period )
